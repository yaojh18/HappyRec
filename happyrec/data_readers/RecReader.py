...
class RecReader(DataReader):
    def read_user(self, filename: str, formatters: dict) -> dict:
        ...
        DEFAULT_LOGGER.debug("user data keys {}:{}".format(len(self.user_data), list(self.user_data.keys())))
        self.user_num = len(self.user_data[UID])
        DEFAULT_LOGGER.info("user_num = {}".format(self.user_num))
    ...
    def read_item(self, filename: str, formatters: dict) -> dict:
        ...
        DEFAULT_LOGGER.debug("item data keys {}:{}".format(len(self.item_data), list(self.item_data.keys())))
    ...
    def group_train_pos_his(self, label_filter=lambda x: x > 0):
        DEFAULT_LOGGER.debug("group_train_pos_his...")
    ...
    def prepare_user_features(self, include_uid: bool = False,
        ...
        DEFAULT_LOGGER.debug("prepare user features...")
        ...
        DEFAULT_LOGGER.debug('user multihot features = {}'.format(mh_f_dict))
        self.user_multihot_f_num = len(mh_f_dict)
        self.user_multihot_f_dim = base
        DEFAULT_LOGGER.info('user_multihot_f_num = {}'.format(self.user_multihot_f_num))
        DEFAULT_LOGGER.info('user_multihot_f_dim = {}'.format(self.user_multihot_f_dim))
        ...
        DEFAULT_LOGGER.debug('user numeric features = {}'.format(nm_f_dict))
        self.user_numeric_f_num = len(nm_f_dict)
        DEFAULT_LOGGER.info('user_numeric_f_num = {}'.format(self.user_numeric_f_num))
    ...
    def prepare_item_features(self, include_iid: bool = False,
                              multihot_features: str = None, numeric_features: str = None):
        DEFAULT_LOGGER.debug("prepare item features...")
        ...
        DEFAULT_LOGGER.debug('item multihot features = {}'.format(mh_f_dict))
        self.item_multihot_f_num = len(mh_f_dict)
        self.item_multihot_f_dim = base
        DEFAULT_LOGGER.info('item_multihot_f_num = {}'.format(self.item_multihot_f_num))
        DEFAULT_LOGGER.info('item_multihot_f_dim = {}'.format(self.item_multihot_f_dim))
        ...
        DEFAULT_LOGGER.debug('item numeric features = {}'.format(nm_f_dict))
        self.item_numeric_f_num = len(nm_f_dict)
        DEFAULT_LOGGER.info('item_numeric_f_num = {}'.format(self.item_numeric_f_num))
    ...
    def prepare_ctxt_features(self, include_time: bool = False,
                              multihot_features: str = None, numeric_features: str = None):
        DEFAULT_LOGGER.debug("prepare context features...")
        ...
        DEFAULT_LOGGER.debug('context multihot features = {}'.format(mh_f_dict))
        self.ctxt_multihot_f_num = len(mh_f_dict)
        self.ctxt_multihot_f_dim = base
        DEFAULT_LOGGER.info('ctxt_multihot_f_num = {}'.format(self.ctxt_multihot_f_num))
        DEFAULT_LOGGER.info('ctxt_multihot_f_dim = {}'.format(self.ctxt_multihot_f_dim))
        ...
        DEFAULT_LOGGER.debug('context numeric features = {}'.format(nm_f_dict))
        self.ctxt_numeric_f_num = len(nm_f_dict)
        DEFAULT_LOGGER.info('ctxt_numeric_f_num = {}'.format(self.ctxt_numeric_f_num))
